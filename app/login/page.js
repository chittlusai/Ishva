...
export default function LoginPage() {
  ...
  const [step, setStep] = useState(0); // 0: Login, 1: Business Type, 2: Budget, 3: Features
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  ...
                  <div>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <input type="tel" placeholder="+91 98765 43210" value={formData.phone} onChange={e => setFormData({...formData, phone: e.target.value})} style={{...inputStyle, paddingLeft: 46}} onFocus={focusStyle} onBlur={blurStyle} />
                    </div>
                  </div>
                </div>
