        ...
        >
          <motion.div
            style={{
              ...
              padding: "4rem 2rem",
              borderRadius: 32,
              boxShadow: "0 50px 100px -20px rgba(139, 92, 246, 0.15)"
            }}
          >
            <motion.div
            ...
            <motion.div
              ...
              style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap", transformStyle: "preserve-3d" }}
            >
              <Link href="/quotation" style={{ transform: "translateZ(80px)" }}>
              ...
              <Link href="/templates" style={{ transform: "translateZ(30px)" }}>
